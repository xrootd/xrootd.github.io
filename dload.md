...
|:--------:|:-----------------------------------------------------------------------:|:-----------:|:-----------------------------:|:-----------:|
|2026-06-20|[xrootd-6.1.0.tar.gz]({{ site.url }}/download/v6.1.0/xrootd-6.1.0.tar.gz)|7213160 bytes|a3878c2c555eede1a0b6468e5920615f|XRootD 6.1.0|
|2026-06-20|[xrootd-5.9.6.tar.gz]({{ site.url }}/download/v5.9.6/xrootd-5.9.6.tar.gz)|6961773 bytes|b30490b704a0b79aa1a4c8029e05625c|XRootD 5.9.6|
...
|2026-05-05|[xrootd-6.0.1.tar.gz]({{ site.url }}/download/v6.0.1/xrootd-6.0.1.tar.gz)|7168580 bytes|062dcceac16c8b62182800744e182235|XRootD 6.0.1|
|2026-05-05|[xrootd-5.9.3.tar.gz]({{ site.url }}/download/v5.9.3/xrootd-5.9.3.tar.gz)|6959059 bytes|6402e97db097c9f0d6ec85102e65cbe0|XRootD 5.9.3|
|2026-04-09|[xrootd-6.0.0.tar.gz]({{ site.url }}/download/v6.0.0/xrootd-6.0.0.tar.gz)|7163716 bytes|d6e30dae97b1ec37e28ef70f3f4e5a7e|XRootD 6.0.0|
|2026-03-27|[xrootd-5.9.2.tar.gz]({{ site.url }}/download/v5.9.2/xrootd-5.9.2.tar.gz)|6956501 bytes|8281700b0a065974bd18bcdd0fb9fe19|XRootD 5.9.2|
|2025-11-17|[xrootd-5.9.1.tar.gz]({{ site.url }}/download/v5.9.1/xrootd-5.9.1.tar.gz)|6946627 bytes|f75636e914fa15c40cf83b8ee8c651a6|XRootD 5.9.1|
|2025-10-10|[xrootd-5.9.0.tar.gz]({{ site.url }}/download/v5.9.0/xrootd-5.9.0.tar.gz)|6944496 bytes|06eac2e869d3604e6da6b4b5fe802edf|XRootD 5.9.0|
|2025-07-10|[xrootd-5.8.4.tar.gz]({{ site.url }}/download/v5.8.4/xrootd-5.8.4.tar.gz)|6902161 bytes|6918d479f3fc3125538ea300be6bab05|XRootD 5.8.4|
|2025-06-05|[xrootd-5.8.3.tar.gz]({{ site.url }}/download/v5.8.3/xrootd-5.8.3.tar.gz)|6895925 bytes|3286a50a42db3b8fafc773b9f63ee202|XRootD 5.8.3|
|2025-05-08|[xrootd-5.8.2.tar.gz]({{ site.url }}/download/v5.8.2/xrootd-5.8.2.tar.gz)|6892307 bytes|ab4e66db90ff77ef5acb031afa9cbdea|XRootD 5.8.2|
|2025-04-15|[xrootd-5.8.1.tar.gz]({{ site.url }}/download/v5.8.1/xrootd-5.8.1.tar.gz)|6891041 bytes|4b73dc249eae160b6ac797516c816fa4|XRootD 5.8.1|
|2025-03-21|[xrootd-5.8.0.tar.gz]({{ site.url }}/download/v5.8.0/xrootd-5.8.0.tar.gz)|6885133 bytes|bd33553826d6c185498394ad44e6f124|XRootD 5.8.0|
|2025-01-28|[xrootd-5.7.3.tar.gz]({{ site.url }}/download/v5.7.3/xrootd-5.7.3.tar.gz)|6833395 bytes|63e0376184aed93b1081ae6301c3381d|XRootD 5.7.3|
|2024-11-29|[xrootd-5.7.2.tar.gz]({{ site.url }}/download/v5.7.2/xrootd-5.7.2.tar.gz)|6826940 bytes|17f6b33e19145ab02ec8bccdd5175543|XRootD 5.7.2|
|2024-09-03|[xrootd-5.7.1.tar.gz]({{ site.url }}/download/v5.7.1/xrootd-5.7.1.tar.gz)|6819353 bytes|52599e6df09016998c09d00115cb5852|XRootD 5.7.1|
|2024-07-01|[xrootd-5.7.0.tar.gz]({{ site.url }}/download/v5.7.0/xrootd-5.7.0.tar.gz)|6807467 bytes|68af782e310c7b6cccf589479de14e34|XRootD 5.7.0|
|2024-03-08|[xrootd-5.6.9.tar.gz]({{ site.url }}/download/v5.6.9/xrootd-5.6.9.tar.gz)|6701277 bytes|48a3fe6e8768305b742dd2d08404114c|XRootD 5.6.9|
|2024-02-23|[xrootd-5.6.8.tar.gz]({{ site.url }}/download/v5.6.8/xrootd-5.6.8.tar.gz)|6700235 bytes|6b3002a6e8783eb8e677187b80348d01|XRootD 5.6.8|
|2024-02-06|[xrootd-5.6.7.tar.gz]({{ site.url }}/download/v5.6.7/xrootd-5.6.7.tar.gz)|6698751 bytes|877d79d4e5d76e77512ad35ce142ea53|XRootD 5.6.7|
|2024-01-25|[xrootd-5.6.6.tar.gz]({{ site.url }}/download/v5.6.6/xrootd-5.6.6.tar.gz)|6698407 bytes|5738566c6dbadfd27c367dce49f92aa1|XRootD 5.6.6|
|2024-01-22|[xrootd-5.6.5.tar.gz]({{ site.url }}/download/v5.6.5/xrootd-5.6.5.tar.gz)|6698610 bytes|e8900bf0167c7a1e894f5c0be037efd3|XRootD 5.6.5|
|2023-12-11|[xrootd-5.6.4.tar.gz]({{ site.url }}/download/v5.6.4/xrootd-5.6.4.tar.gz)|6696858 bytes|ea36b0c9b6acdae60cad29e93de8fb02|XRootD 5.6.4|
|2023-10-27|[xrootd-5.6.3.tar.gz]({{ site.url }}/download/v5.6.3/xrootd-5.6.3.tar.gz)|3257144 bytes|a210ca0d64421fadb32fd98b9984e386|XRootD 5.6.3|
|2023-09-15|[xrootd-5.6.2.tar.gz]({{ site.url }}/download/v5.6.2/xrootd-5.6.2.tar.gz)|3251295 bytes|da6ac07199bd0f900f535508e2e74236|XRootD 5.6.2|
|2023-07-11|[xrootd-5.6.1.tar.gz]({{ site.url }}/download/v5.6.1/xrootd-5.6.1.tar.gz)|3278351 bytes|3bb2c7d02a2399d8a82849803d2175cc|XRootD 5.6.1|
|2023-06-30|[xrootd-5.6.0.tar.gz]({{ site.url }}/download/v5.6.0/xrootd-5.6.0.tar.gz)|3277803 bytes|91d5a879ef9e3b82416efac64436be35|XRootD 5.6.0|
...
```
dnf config-manager --add-repo {{ site.url }}/xrootd.repo
```
...
```
rpm --import {{ site.url }}/repo/RPM-GPG-KEY.txt
```
...
```
echo "deb {{ site.url }}/debian trixie stable" >> /etc/apt/sources.list.d/xrootd.list
```

On Ubuntu 26.04, run the following instead

```
echo "deb {{ site.url }}/ubuntu resolute stable" >> /etc/apt/sources.list.d/xrootd.list
```
